...
public class Parameter_passing_experiments {
  ...
  //---------------------------------------------------------------    
  public static void bracketText(char c, int numberSpaces) { //Method overloading
    System.out.print(c);
  ...
  //---------------------------------------------------------------    
  public static void bracketText(String str, int numberSpaces) { //Method overloading
