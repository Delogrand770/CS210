...
public class Lab04_Experiments {
  ...
  public static void Experiment2() {
    ...
    int answer1 = alpha + beta * gamma - 1;
  ...
  public static void Experiment3() {
    ...
    byte  answer1 = (byte) (alpha + beta * gamma - delta);
    short answer2 = (short) (alpha + beta * gamma - delta);
    int   answer3 = (int) (alpha + beta * gamma - delta);
  ...
  public static void Experiment4() {
    ...
    float alpha = (float) 2.4;
    double beta = 2.0;


    float  answer1 = (float) (alpha * beta);
    double answer2 = (alpha * beta);
    int    answer3 = (int) (alpha * beta);
  ...
  public static void Experiment5() {
    ...
    char answer3 = (char) ((int) gamma - 31);
  ...
  public static void Experiment7() {
		  ...
		  float  answer1 = alpha;
		  float  answer2 = alpha + 1;
		  float  answer3 = alpha + 129;
		  
		  System.out.printf("answer1 = %3.00f\n", answer1 );
