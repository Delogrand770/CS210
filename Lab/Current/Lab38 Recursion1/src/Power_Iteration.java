...
public class Power_Iteration {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("2^5 = " + recursivePower(2, 5));
    System.out.println("10^3 = " + recursivePower(10, 3));
    System.out.println("3^12 = " + recursivePower(3, 12));
    System.out.println("5^5 = " + recursivePower(5, 5));
  }
